-- Coped from commit 389f1c9af5dc9e3e32ae674e66f57c53383da9c8
--
...
-- Customizations(deparr)
local hl = vim.api.nvim_set_hl
-- base16
hl(0, "Normal", { fg = gui05, ctermfg = cterm05, bg = "NONE", ctermbg = "NONE" })
hl(0, "NormalFloat", { fg = gui05, ctermfg = cterm05, bg = gui01, ctermbg = cterm01 })
hl(0, "FloatTitle",  { fg = gui0D, ctermfg = cterm0D, bg = gui01, ctermbg = cterm01 })
hl(0, "WinSeparator", { fg = gui03, ctermfg = cterm03 })
hl(0, "SignColumn", { fg = gui03, ctermfg = cterm03, bg = "NONE", ctermbg = "NONE" })
hl(0, "LineNr", { fg = gui03, ctermfg = cterm03, bg = "NONE", ctermbg = "NONE" })
hl(0, "Added", { link = "DiffAdd" })
hl(0, "Removed", { link = "DiffRemoved" })
hl(0, "Changed", { link = "DiffTextAdd" })
hl(0, "StatusLine", { fg = gui04, bg = gui01, ctermfg = cterm04, ctermbg = cterm01 })
hl(0, "PmenuSel", { fg = gui0D, ctermfg = cterm0D, bg = gui02, ctermbg = cterm02 })
hl(0, "DiagnosticInfo", { fg = gui04 })
hl(0, "DiagnosticVirutalTextInfo", { fg = gui04})
hl(0, "DiagnosticUnderlineError", { ctermfg = cterm00, ctermbg = cterm08, undercurl = true, sp = gui08 })
hl(0, "DiagnosticUnderlineWarn", { ctermfg = cterm00, ctermbg = cterm09, undercurl = true, sp = gui09 })
hl(0, "DiagnosticUnderlineInfo", { ctermfg = cterm00, ctermbg = cterm0C, undercurl = true, sp = gui04 })
hl(0, "DiagnosticUnderlineHint", { ctermfg = cterm00, ctermbg = cterm0D, undercurl = true, sp = gui0D })
hl(0, "DiagnosticUnderlineOk", { ctermfg = cterm00, ctermbg = cterm0B, undercurl = true, sp = gui0B })

hl(0, "Delimiter", { fg = gui04, ctermfg = cterm04 })
hl(0, "Identifier", { fg = "fg", ctermfg = cterm05 })
hl(0, "Character", { link = "String" })
hl(0, "Constant", { fg = "fg", ctermfg = cterm05 })

hl(0, "@attribute.builtin", { fg = gui0C, ctermfg = cterm0C })
hl(0, "@comment.documentation", { link = "SpecialComment" })
hl(0, "@constant.builtin", { fg = gui09, ctermfg = cterm09 })
hl(0, "@diff.plus", { link = "DiffAdd" })
hl(0, "@diff.minus", { link = "DiffRemoved" })
hl(0, "@diff.delta", { link = "DiffTextAdd" })
hl(0, "@function", { fg = gui0D, ctermfg = cterm0D })
hl(0, "@function.builtin", { fg = gui0D, ctermfg = cterm0D })
hl(0, "@keyword.operator", { fg = gui0E, ctermfg = cterm0E })
hl(0, "@module.builtin", { fg = gui05, ctermfg = cterm05 })
hl(0, "@string.special.path", { fg = gui0D, ctermfg = cterm0D })
hl(0, "@tag.builtin", { fg = gui09, ctermfg = cterm09 })
hl(0, "@type.builtin", { fg = gui0A, ctermfg = cterm0A })
hl(0, "@variable.builtin", { fg = gui05, ctermfg = cterm05 })
...
hl(0, "BlinkCmpKindConstant", { link = "Number" })
hl(0, "BlinkCmpKindValue", { link = "Number" })
hl(0, "BlinkCmpKindEvent", { link = "DiagnosticWarn" })
hl(0, "BlinkCmpKindKeyword", { link = "Keyword" })
hl(0, "BlinkCmpKindStruct", { link = "Keyword" })

-- gruvbox
hl(0, "SpecialComment", { link = "Special" }) -- 0f in tm
hl(0, "Comment", { fg = gui09, ctermfg = cterm09 }) -- not in tm
hl(0, "@constant.builtin", { fg = gui09, ctermfg = cterm09 })
hl(0, "@string.special.url", { fg = gui0D, ctermfg = cterm0D }) -- 0f in tm
